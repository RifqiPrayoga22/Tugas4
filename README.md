...
<title>Sesi 4 – Polimorfisme & Abstraksi | Rifqi Prayoga · 251410005 · SI2A</title>
...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  .student-name{font-size:1rem;font-weight:800;color:var(--text);}
  .student-meta{font-size:.8rem;color:var(--muted);margin-top:2px;}
  .student-meta span{color:var(--accent2);font-weight:700;margin:0 6px;}
  ...
  <div class="section">
    ...
    <div class="code-wrapper">
      <div class="code-header">
        ...
        <a class="dartpad-btn" href="https://dartpad.dev/?run=true&split=embed-dart.html?id=74f05c93643ff64d6863750890f61621&run=true" target="_blank">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polygon points="5,3 19,12 5,21"/></svg>
          Buka di DartPad
        </a>
      </div>
<pre><span class="kw">class</span> <span class="cl">Bentuk</span> {
    ...
    b.<span class="fn">gambar</span>();
      ...
      <div class="iframe-wrap">
        <div class="iframe-hdr">
          ...
          <a href="https://dartpad.dev/?run=true&split=embed-dart.html?id=74f05c93643ff64d6863750890f61621&run=true" target="_blank" class="full-btn">Layar Penuh ↗</a>
        </div>
        <iframe src="https://dartpad.dev/embed-dart.html?id=74f05c93643ff64d6863750890f61621&run=true" width="100%" height="440" frameborder="0" loading="lazy"></iframe>
      </div>
    </div>
    <div class="code-wrapper">
      <div class="code-header">
        <span class="code-lang">🎯 Operator <code>is</code> dan <code>as</code></span>
        <a class="dartpad-btn" href="https://dartpad.dev/?run=true&split=60&source=class%20Kendaraan%20%7B%0A%20%20String%20nama%3B%0A%20%20Kendaraan%28this.nama%29%3B%0A%7D%0Aclass%20Mobil%20extends%20Kendaraan%20%7B%0A%20%20Mobil%28String%20nama%29%20%3A%20super%28nama%29%3B%0A%20%20void%20klakson%28%29%20%3D%3E%20print%28%27%24nama%3A%20Tin-Tin%21%27%29%3B%0A%7D%0Aclass%20Motor%20extends%20Kendaraan%20%7B%0A%20%20Motor%28String%20nama%29%20%3A%20super%28nama%29%3B%0A%20%20void%20knalpot%28%29%20%3D%3E%20print%28%27%24nama%3A%20Froorr%21%27%29%3B%0A%7D%0Avoid%20main%28%29%20%7B%0A%20%20List%3CKendaraan%3E%20kendaraan%20%3D%20%5BMobil%28%27Toyota%27%29%2C%20Motor%28%27Honda%27%29%2C%20Mobil%28%27BMW%27%29%5D%3B%0A%20%20for%20%28var%20k%20in%20kendaraan%29%20%7B%0A%20%20%20%20if%20%28k%20is%20Mobil%29%20%7B%0A%20%20%20%20%20%20%28k%20as%20Mobil%29.klakson%28%29%3B%0A%20%20%20%20%7D%20else%20if%20%28k%20is%20Motor%29%20%7B%0A%20%20%20%20%20%20%28k%20as%20Motor%29.knalpot%28%29%3B%0A%20%20%20%20%7D%0A%20%20%7D%0A%7D" target="_blank">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polygon points="5,3 19,12 5,21"/></svg>
          Buka di DartPad
        </a>
      </div>
<pre><span class="kw">class</span> <span class="cl">Kendaraan</span> { <span class="ty">String</span> nama; <span class="cl">Kendaraan</span>(<span class="kw">this</span>.nama); }
  ...
  <span class="kw">for</span> (<span class="kw">var</span> k <span class="kw">in</span> list) {
    ...
    <span class="kw">else if</span> (k <span class="kw">is</span> <span class="cl">Motor</span>) (k <span class="kw">as</span> <span class="cl">Motor</span>).<span class="fn">knalpot</span>();
      ...
      <div class="iframe-wrap">
        ...
        <iframe src="https://dartpad.dev/embed-dart.html?id=87fdd0a219d4c5530bb32032151feb8a&run=true" width="100%" height="440" frameborder="0" loading="lazy"></iframe>
      </div>
    </div>
  </div>
...
<span class="kw">void</span> <span class="fn">main</span>() {
  ...
  <span class="kw">for</span> (<span class="kw">var</span> k <span class="kw">in</span> garasi) { <span class="fn">print</span>(k.<span class="fn">getInfo</span>()); k.<span class="fn">start</span>(); k.<span class="fn">stop</span>(); <span class="fn">print</span>(<span class="st">'---'</span>); }
      ...
      <div class="iframe-wrap">
        ...
        <iframe src="https://dartpad.dev/embed-dart.html?id=2ac19c1124a96ead41e805ce8c8cd116&run=true" width="100%" height="440" frameborder="0" loading="lazy"></iframe>
      </div>
    </div>
  </div>
...
<span class="kw">void</span> <span class="fn">main</span>() {
  ...
  <span class="cl">Itik</span>().<span class="fn">berenang</span>();
      ...
      <div class="iframe-wrap">
        ...
        <iframe src="https://dartpad.dev/embed-dart.html?id=b5fcf8ed2139ecc31f04793233f4962c&run=true" width="100%" height="440" frameborder="0" loading="lazy"></iframe>
      </div>
    </div>
  </div>
...
<span class="kw">void</span> <span class="fn">main</span>() {
  ...
  <span class="fn">print</span>(<span class="st">'Luas r=5 = ${MathUtils.lingkaranLuas(5).toStringAsFixed(2)}'</span>);
      ...
      <div class="iframe-wrap">
        ...
        <iframe src="https://dartpad.dev/embed-dart.html?id=213bac0c12e683ceff2108f259f065fd&run=true" width="100%" height="440" frameborder="0" loading="lazy"></iframe>
      </div>
    </div>
  </div>
  ...
  <span class="at">@override</span> <span class="ty">String</span> <span class="fn">getNama</span>() <span class="op">=></span> <span class="st">'Tunai'</span>;
      ...
      <div class="out-panel">
        ...
        <div class="out-body">
          ...
          <div class="out-line">Bayar Rp150000 Kartu Kredit (****3456)</div>
          <div class="out-line">Status: Sukses</div>
          <div class="out-line"></div>
          <div class="out-line">=== Transaksi dengan E-Wallet Gopay ===</div>
          <div class="out-line">Bayar Rp75000 EWallet Gopay</div>
          <div class="out-line">Status: Sukses</div>
          <div class="out-line"></div>
          <div class="out-line">=== Transaksi dengan Tunai ===</div>
          <div class="out-line">Bayar Rp50000 Tunai</div>
          <div class="out-line">Status: Sukses</div>
        </div>
      </div>
      <div class="iframe-wrap">
        ...
        <iframe src="https://dartpad.dev/embed-dart.html?id=3ce0b2d43a1c64524ab1550375b58e43&run=true" width="100%" height="440" frameborder="0" loading="lazy"></iframe>
      </div>
    </div>
  </div>
...
<span class="kw">void</span> <span class="fn">main</span>() {
  ...
  <span class="kw">for</span> (<span class="kw">var</span> p <span class="kw">in</span> tim) { p.<span class="fn">perkenalkanDiri</span>(); p.<span class="fn">bekerja</span>(); <span class="fn">print</span>(<span class="st">'--'</span>); }
      ...
      <div class="iframe-wrap">
        ...
        <iframe src="https://dartpad.dev/embed-dart.html?id=644ce0c7b428e5a6023444ee7ee8b018&run=true" width="100%" height="440" frameborder="0" loading="lazy"></iframe>
      </div>
    </div>
...
<span class="kw">class</span> <span class="cl">Tablet</span> <span class="kw">implements</span> <span class="cl">Komputer</span>, <span class="cl">Kamera</span>, <span class="cl">Telepon</span> {
  ...
  <span class="at">@override</span> <span class="kw">void</span> <span class="fn">kirimSms</span>(<span class="ty">String</span> pesan)  <span class="op">=></span> <span class="fn">print</span>(<span class="st">'[$merk] SMS: $pesan'</span>);
      ...
      <div class="iframe-wrap">
        ...
        <iframe src="https://dartpad.dev/embed-dart.html?id=a7e1e1cdd8442c000baf8ef664dc82da&run=true" width="100%" height="440" frameborder="0" loading="lazy"></iframe>
      </div>
    </div>
  ...
  <span class="kw">static</span> <span class="ty">double</span> <span class="fn">median</span>(<span class="ty">List</span>&lt;<span class="ty">num</span>&gt; a) {
    ...
    <span class="kw">return</span> s.length<span class="op">%</span><span class="nu">2</span><span class="op">==</span><span class="nu">0</span> ? (s[m<span class="op">-</span><span class="nu">1</span>]<span class="op">+</span>s[m])<span class="op">/</span><span class="nu">2</span> : s[m].<span class="fn">toDouble</span>();
      ...
      <div class="iframe-wrap">
        ...
        <iframe src="https://dartpad.dev/embed-dart.html?id=004ef1499deb34fa657fe32a40972229&run=true" width="100%" height="440" frameborder="0" loading="lazy"></iframe>
      </div>
    </div>
  </div>
